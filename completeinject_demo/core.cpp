...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	_snprintf(dllPath, MAX_PATH, "C:\\backup\\project\\vc\\InJectFun\\Debug\\InJectFun.dll");
	...
	*/
    DWORD dwProcessId = processNameToId("NetBidClient.exe");
    HANDLE hTargetProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, dwProcessId);
	// Inject the DLL, the export function is named 'Initialize'
	Inject(hTargetProcess, dllPath, "Initialize");
	//MessageBox(0, "ok", "ok", MB_ICONERROR);
